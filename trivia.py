...
#INSTRUCCIONES
time.sleep(1)
print("Cargando Instrucciónes ... ")
time.sleep(2)
print(YELLOW+"""Bien ahora responda las siguientes preguntas escribiendo la letra de la alternativa y presionando 'Enter' para enviar tu respuesta\n"""+RESET)
...
#VERIFICAR RESPUESTA
    ...
    print(YELLOW + """ C fue creado en 1972 por Dennis M. Ritchie en los Laboratorios Bell como evolución del anterior lenguaje B."""+RESET)
#PUNTOS ACUMULADOS      
    time.sleep(1)
...
#VERIFICAR RESPUESTA
    if respuesta_2 == "b":
        ...
        print(RI)
        puntaje -= random.randint(1, 5)
    print(YELLOW + """ Así es, esta era la contraseña “súper segura” que estuvo ocho años activa y que daba acceso al control informático de las cabezas nucleares de Estados Unidos."""+RESET)
...
#VERIFICAR RESPUESTA  
    if respuesta_4 == "c":
        ...
        print(RI)
        puntaje -= random.randint(1, 5)
    print(YELLOW + """ La respuesta correcta es: Unicode es un sistema de codificación informático que tiene como objetivo unificar los intercambios de texto a nivel internacional. Cada carácter se describe con un nombre y un código que lo identifica de manera única, independientemente del medio informático o el software utilizado."""+RESET)
